const tokens = {
  ...
  "colors.fog": {
    "value": "#9A8C98",
    "variable": "var(--colors-fog)"
  },
  "colors.lake": {
    "value": "#778DA9",
    "variable": "var(--colors-lake)"
  },
  "colors.darkNight": {
    "value": "#22223B",
    "variable": "var(--colors-dark-night)"
  },
  "breakpoints.sm": {
    "value": "640px",
  ...
  "colors.card.color": {
    "value": "var(--colors-card-color)",
    "variable": "var(--colors-card-color)"
  },
  "colors.card.background": {
    "value": "var(--colors-card-background)",
